...
#define STRING_CONFIG_H_AUTHOR "(Alfamyk, E1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Alfamyk E1"
...
#define HOMING_FEEDRATE_MM_M { (20*60), (20*60), (5*60) }
